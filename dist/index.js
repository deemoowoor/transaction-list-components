      ...
      React.createElement(
        "form",
        {
          onSubmit: function onSubmit(event) {
            ...
            return _onSubmit({ event: event, uuid: uuid.v4(), currency: currency, amount: amount });
          }
        },
        React.createElement(
          FormControl,
        ...
        function (_ref6) {
          ...
          return React.createElement(
            ...
            columns.map(function (_ref8, index) {
              ...
              return React.createElement(reactVirtualized.Column, _extends({
                key: dataKey,
...
var EnhancedTable = styles.withStyles(styles$1)(EnhancedVirtualizedTable);

var useToolbarStyles = styles.makeStyles(function (theme) {
  return {
    root: {
    ...
    highlight: theme.palette.type === "light" ? {
      ...
      backgroundColor: styles.lighten(theme.palette.secondary.light, 0.8)
    } : {
...
var QUERY_TRANSACTIONS_AND_CURRENCIES = client.gql(_templateObject);

var ADD_TRANSACTION = client.gql(_templateObject2);

var UPDATE_TRANSACTION = client.gql(_templateObject3);

var DELETE_BULK_TRANSACTIONS = client.gql(_templateObject4);
...
var LoadingCard = function LoadingCard() {
  return React.createElement(
    ...
    React.createElement(core.LinearProgress, { color: "primary" })
  );
};
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return addTransaction({
                variables: { uuid: uuid$$1, currency: currency, amount: parseFloat(amount) }
              });
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return updateTransaction({
                variables: { id: id, uuid: uuid$$1, currency: currency, amount: parseFloat(amount) }
              });
